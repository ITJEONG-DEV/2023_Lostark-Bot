...
def get_abyss_dungeons_info(authorization):
    request_url = "https://developer-lostark.game.onstove.com/gamecontents/challenge-abyss-dungeons"
...
def get_guardian_raid_info(authorization):
    request_url = "https://developer-lostark.game.onstove.com/gamecontents/challenge-guardian-raids"
...
def make_weekly_challenge_contents(authorization):
    ...
    # 도비스
    abyss_info = get_abyss_dungeons_info(authorization)
    ...
    # 도가토
    guardian_info = get_guardian_raid_info(authorization)
